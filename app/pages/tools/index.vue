...
const { data, pending, error, refresh } = await useFetch<{ tools: Tool[], total: number }>('/api/tools', {
  query: computed(() => ({
  ...
  <div class="p-4 md:p-8">
    ...
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-8">
      <div class="hidden md:flex justify-between items-center mb-10">
        <h1 class="text-2xl font-bold text-slate-900 tracking-tight">Manage Tools</h1>
      </div>
            ...
            <TableCell class="text-right">
              <DropdownMenu>
                ...
                <DropdownMenuContent align="end" class="w-48">
                  <DropdownMenuItem @click="openDialog(tool)" class="cursor-pointer">
        ...
        <div class="space-y-4 py-4">
          <div>
            ...
            <Input 
              ...
              :class="{ 'border-red-500 focus-visible:ring-red-500': fieldErrors.name }"
              maxlength="50"
            />
