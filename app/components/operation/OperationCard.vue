...
import { Building2, Calendar, Eye, MapPin, MoreVertical, Pencil, Trash2, UserCheck, Users } from 'lucide-vue-next'
import type { Operation } from '../../../shared/types/operation'
import { OPERATION_STATUS_BADGE_CLASS, OPERATION_TYPE_BADGE_CLASS } from '@/constants/operation'
...
<template>
  ...
  >
      ...
      <div class="flex justify-between items-start mb-3 gap-3">
        ...
        <DropdownMenu v-if="props.isIM">
          ...
          <DropdownMenuContent align="end">
            <DropdownMenuItem class="cursor-pointer" @click="emit('view', props.operation)">
            ...
            <DropdownMenuItem
              v-if="props.operation.status !== 'Complete' && props.operation.status !== 'Cancelled'"
    ...
    <CardContent class="space-y-3 pt-0">
      ...
      <div v-if="!props.operation.vesselName" class="flex items-center gap-2 text-sm text-gray-700">
