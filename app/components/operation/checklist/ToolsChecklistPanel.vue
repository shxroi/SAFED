...
<template>
  <div class="space-y-4">
    ...
    >
      <div
        class="mb-4 flex gap-2 rounded-md bg-slate-100 px-3 py-2 flex-row items-center justify-between"
      >
      ...
      <div class="mb-2 space-y-3">
        <div class="px-3">
          ...
          >
            ...
            <div v-if="props.editable" class="flex gap-2">
              <Button
                size="sm"
                class="h-8 w-14 rounded-md bg-green-300 text-green-800 hover:bg-green-400"
                :class="
                  tool.preStatus === 'Good' ? 'ring-2 ring-green-500' : ''
                "
              ...
              <Button
                size="sm"
                class="h-8 w-14 rounded-md bg-red-300 text-red-800 hover:bg-red-400"
                :class="
        ...
        <Textarea
          ...
          placeholder="Type pre-condition note…"
          class="min-h-21 border-slate-200 bg-white text-sm"
          @update:model-value="
      ...
      <div class="space-y-3">
          ...
          >
            ...
            <div v-if="props.editable" class="flex gap-2">
              <Button
                ...
                class="h-8 w-14 rounded-md bg-green-300 text-green-800 hover:bg-green-400"
                :class="
                  tool.postStatus === 'Good' ? 'ring-2 ring-green-500' : ''
                "
        ...
        <Textarea
          ...
          class="min-h-[84px] border-slate-200 bg-white text-sm"
          @update:model-value="
