      ...
      >
        ...
        <DropdownMenu>
          <DropdownMenuTrigger as-child>
            <div
              class="w-8 h-8 md:w-10 md:h-10 rounded-full bg-slate-200 flex items-center justify-center border-2 border-white shadow-sm cursor-pointer overflow-hidden hover:ring-slate-100n transtision-all"
            >
              <NuxtImg
                :src="Avatar"
                alt="User avatar"
